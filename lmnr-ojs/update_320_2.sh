...
sudo chmod -R 777 ojs-3.2.0-2/cache
sudo chmod -R 777 ojs-3.2.0-2/public
sudo chmod -R 777 ojs-3.2.0-2/plugins
...
echo "ver ojs-3.2.0-2"  
php ojs-3.2.0-2/tools/upgrade.php upgrade
