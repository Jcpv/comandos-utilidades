...
sudo chmod -R 777 ojs-3.2.0-4/cache
sudo chmod -R 777 ojs-3.2.0-4/public
sudo chmod -R 777 ojs-3.2.0-4/plugins
...
echo "ver ojs-3.2.0-4"  
php ojs-3.2.0-4/tools/upgrade.php upgrade
